package reqsysmdd.pl_aovgraph2featuremodel.files;
...
import org.xtext.plaovgraph.PLAOVgraphStandaloneSetup;
...
public class Xtext_PLAOVgraph2FeatureModel {

    public Xtext_PLAOVgraph2FeatureModel(String inModelPath, String outModelPath) throws IOException {
    	...
    	Injector injector = new PLAOVgraphStandaloneSetup().createInjectorAndDoEMFRegistration();
