 ...
 * @generated
 */
public class PlaovgraphSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PlaovgraphPackage.ASPECT_ORIENTED_MODEL: {
				Aspect_Oriented_Model aspect_Oriented_Model = (Aspect_Oriented_Model)theEObject;
				T result = caseAspect_Oriented_Model(aspect_Oriented_Model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.GOAL_MODEL: {
				Goal_Model goal_Model = (Goal_Model)theEObject;
				T result = caseGoal_Model(goal_Model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = caseGoal_Model(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.RELATIONSHIP: {
				Relationship relationship = (Relationship)theEObject;
				T result = caseRelationship(relationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.IS_FEATURE: {
				IsFeature isFeature = (IsFeature)theEObject;
				T result = caseIsFeature(isFeature);
				if (result == null) result = caseProperty(isFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.CARDINALITY: {
				Cardinality cardinality = (Cardinality)theEObject;
				T result = caseCardinality(cardinality);
				if (result == null) result = caseProperty(cardinality);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.GROUP_FEATURE: {
				GroupFeature groupFeature = (GroupFeature)theEObject;
				T result = caseGroupFeature(groupFeature);
				if (result == null) result = caseProperty(groupFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.GENERIC_PROPERTY: {
				Generic_Property generic_Property = (Generic_Property)theEObject;
				T result = caseGeneric_Property(generic_Property);
				if (result == null) result = caseProperty(generic_Property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.CONTRIBUTION: {
			...
			case PlaovgraphPackage.CORRELATION: {
			...
			case PlaovgraphPackage.CROSSCUTTING: {
				Crosscutting crosscutting = (Crosscutting)theEObject;
				T result = caseCrosscutting(crosscutting);
				if (result == null) result = caseRelationship(crosscutting);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.POINTCUT: {
				Pointcut pointcut = (Pointcut)theEObject;
				T result = casePointcut(pointcut);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.OPERAND: {
				Operand operand = (Operand)theEObject;
				T result = caseOperand(operand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.OPERATOR: {
				Operator operator = (Operator)theEObject;
				T result = caseOperator(operator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.ADVICE: {
				Advice advice = (Advice)theEObject;
				T result = caseAdvice(advice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlaovgraphPackage.INTERTYPE_DECLARATION: {
			...
			case PlaovgraphPackage.ATTRIBUTE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Aspect Oriented Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Aspect Oriented Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAspect_Oriented_Model(Aspect_Oriented_Model object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGeneric_Property(Generic_Property object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Intertype Declaration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Intertype Declaration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
