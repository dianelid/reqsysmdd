 ...
 * <ul>
 *   <li>{@link plaovgraph.impl.PointcutImpl#getName <em>Name</em>}</li>
 *   <li>{@link plaovgraph.impl.PointcutImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointcutImpl extends EObjectImpl implements Pointcut {
	...
	protected EClass eStaticClass() {
		return PlaovgraphPackage.Literals.POINTCUT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlaovgraphPackage.POINTCUT__NAME, oldName, name));
	}
	...
	public EList<Operand> getOperand() {
		if (operand == null) {
			operand = new EObjectContainmentEList<Operand>(Operand.class, this, PlaovgraphPackage.POINTCUT__OPERAND);
		}
		return operand;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlaovgraphPackage.POINTCUT__OPERAND:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PlaovgraphPackage.POINTCUT__NAME:
				return getName();
			case PlaovgraphPackage.POINTCUT__OPERAND:
				return getOperand();
		}
