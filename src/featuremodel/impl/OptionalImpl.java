 ...
 * <ul>
 *   <li>{@link featuremodel.impl.OptionalImpl#getCardinalityMin <em>Cardinality Min</em>}</li>
 *   <li>{@link featuremodel.impl.OptionalImpl#getCardinalityMax <em>Cardinality Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OptionalImpl extends RelationshipImpl implements Optional {
	/**
	...
	protected EClass eStaticClass() {
		return FeaturemodelPackage.Literals.OPTIONAL;
	}
	...
	public void setCardinalityMin(String newCardinalityMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturemodelPackage.OPTIONAL__CARDINALITY_MIN, oldCardinalityMin, cardinalityMin));
	}
	...
	public void setCardinalityMax(String newCardinalityMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturemodelPackage.OPTIONAL__CARDINALITY_MAX, oldCardinalityMax, cardinalityMax));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeaturemodelPackage.OPTIONAL__CARDINALITY_MIN:
				return getCardinalityMin();
			case FeaturemodelPackage.OPTIONAL__CARDINALITY_MAX:
