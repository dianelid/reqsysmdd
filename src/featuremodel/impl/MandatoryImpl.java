 ...
 * <ul>
 *   <li>{@link featuremodel.impl.MandatoryImpl#getCardinalityMin <em>Cardinality Min</em>}</li>
 *   <li>{@link featuremodel.impl.MandatoryImpl#getCardinalityMax <em>Cardinality Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MandatoryImpl extends RelationshipImpl implements Mandatory {
	/**
	 ...
	 * @ordered
	 */
	protected static final String CARDINALITY_MIN_EDEFAULT = "";
	 ...
	 * @ordered
	 */
	protected static final String CARDINALITY_MAX_EDEFAULT = "";
	...
	protected EClass eStaticClass() {
		return FeaturemodelPackage.Literals.MANDATORY;
	}
	...
	public void setCardinalityMin(String newCardinalityMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturemodelPackage.MANDATORY__CARDINALITY_MIN, oldCardinalityMin, cardinalityMin));
	}
	...
	public void setCardinalityMax(String newCardinalityMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturemodelPackage.MANDATORY__CARDINALITY_MAX, oldCardinalityMax, cardinalityMax));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeaturemodelPackage.MANDATORY__CARDINALITY_MIN:
				return getCardinalityMin();
			case FeaturemodelPackage.MANDATORY__CARDINALITY_MAX:
